...
CREATE TABLE "DB1lab01"."lab04"."zajecia" (
...
CREATE TABLE "DB1lab01"."lab04"."aktywnosc" (
                "id_zajecia" INTEGER NOT NULL,
...
ALTER TABLE "DB1lab01"."lab04"."zajecia" ADD CONSTRAINT "kurs_zajecia_fk"
FOREIGN KEY ("id_kurs")
REFERENCES "DB1lab01"."lab04"."kurs" ("id_kurs")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;

ALTER TABLE "DB1lab01"."lab04"."aktywnosc" ADD CONSTRAINT "uczestnik_aktywnosc_fk"
...
ALTER TABLE "DB1lab01"."lab04"."aktywnosc" ADD CONSTRAINT "zajecia_aktywnosc_fk"
FOREIGN KEY ("id_zajecia")
REFERENCES "DB1lab01"."lab04"."zajecia" ("id_zajecia")
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
-------------------
